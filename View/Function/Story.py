...
class Story(): # 主要放故事簡介
    def __init__(self):
        self.db = {
            1: ["在這個充滿未知與危險的密室中，你必須在兩扇門之間做出選擇。這是一個充滿冒險和探索的故事，讓你感受到冒險和探索的樂趣，並且教會你如何在黑暗中找到光明，如何面對並解決未知的謎題。你將學到2進制和16進制的知識，並且將自己的視野和思想擴展到更廣闊的領域。走過神秘的門，開啟你的冒險之旅吧！", "故事1", "View/Resource/menu/story1.jpeg"],
