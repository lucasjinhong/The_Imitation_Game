...
class Menu(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        if sys.platform == "win32":
            # Win-125%
            font_button = self.create_font("Microsoft JhengHei UI", 12)
            font_label = self.create_font("Microsoft JhengHei UI", 16)
            font_label_intro = self.create_font("Microsoft JhengHei UI", 11)
        else:
            # Mac
            font_button = self.create_font("Arial", 18)
            font_label = self.create_font("Arial", 24)
            font_label_intro = self.create_font("Arial", 18)
        ...
        self.label_intro.setFont(font_label_intro)
